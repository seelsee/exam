...
var ul3 = document.querySelector('.ul3').getElementsByTagName('li');
...
function pic(p1) {
    ...
    for (var _i = 0; _i < 7; _i++) {
        ...
        if (p1 == 1) {
            ul3[_i].style.background = array[_i];
        }
        if (p1 == 2) {
            ul3[_i].style.background = array[_i + 1];
        }
        if (p1 == 3) {
            ul3[_i].style.background = array[_i + 2];
        }
        if (p1 == 4) {
            ul[_i].style.background = array[_i + 3];
        }
        if (p1 == 5) {
            ul[_i].style.background = array[_i + 4];
        }
        if (p1 == 6) {
            ul3[_i].style.background = array[_i + 5];
        }
        if (p1 == 7) {
            ul3[_i].style.background = array[_i + 6];
        }
    }
}
//ajax
